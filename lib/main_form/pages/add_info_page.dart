                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    _images.length >=
                                                                        ...
                                                                        ? null
                                                                        : () {
                                                                            _picker.pickMultiImage(imageQuality: 50).then((files) {
                                                                  ...
                                                                  showDialog(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content:
                                                                              const Text("Zgłoszenie zaktualizowano pomyślnie."),
                                                                        );
                                                                      });
                                                                  ScaffoldMessenger.of(
                                                                          context)
                                                                    ...
                                                                    const SnackBar(
                                                                        content:
                                                                            Text('Zgłoszenie zaktualizowano pomyślnie')),
                                                                  );
                                                                  //clear form
                                                                  _formKey
                                                                      .currentState
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content:
                                                                              const Center(
                                                                            child:
                                                                                Text("Wystąpił błąd podczas wysyłania zgłoszenia"),
                                                                          ),
                                                                        );
                                                                      });
                                                                  ScaffoldMessenger.of(
